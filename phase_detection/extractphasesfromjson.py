...
def detectphases(inputfilebase, dowrite=True):
	...
	phases = "";
	if dowrite: 
		outfile = open(inputfilebase + '_phases.csv','w') 
		outfile.write("timestamp,phase,action\n")
	lastpattern = ""
...
for f  in glob.glob('e:/igbldata/B1/*_003.json'):
	# parsegamelog(f[:-9])
#	print (f[15:-9]+" ")
	detectphases(f[:-9], True)

#detectphases('e:/igbldata/opencvtest/X19_ABCDE_stats_log_20180828_16u57m')
#parsegamelog('e:/igbldata/opencvtest/X19_ABCDE_stats_log_20180828_16u57m')
